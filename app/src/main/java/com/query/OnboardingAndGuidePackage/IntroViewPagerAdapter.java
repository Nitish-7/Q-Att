...
public class IntroViewPagerAdapter extends PagerAdapter {
    Context mContext;
    List<com.query.OnboardingAndGuidePackage.ScreenItem> mListScreen;

    public IntroViewPagerAdapter(Context mContext, List<com.query.OnboardingAndGuidePackage.ScreenItem> mListScreen){
